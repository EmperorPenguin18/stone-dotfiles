...
#Install packages
pacman -S xorg xorg-xinit spectrwm rxvt-unicode xsel alsa-utils file jq mediainfo xdotool imlib2 w3m ffmpegthumbnailer mpv nfs-utils unclutter pyalpm python-commonmark go --noconfirm --needed
