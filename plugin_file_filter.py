...
#
# This plugin hides the directories unless
...
HIDE_FILES = ("/bin", "/boot", "/boot.bak", "/dev", "/etc", "/home", "/lib", "/lost+found", "/media/Downloads", "/mnt", "/opt", "/proc", "/root", "/run", "/sbin", "/srv", "/sys", "/tmp", "/usr", "/var")
